      ...
      io.set('authorization', function(handshakeData, callback){
        if(handshakeData.headers.cookie){
          handshakeData.cookie = cookie.parse(
            decodeURIComponent(handshakeData.headers.cookie));
          var signature = require('cookie-signature');
          var sid = handshakeData.cookie['connect.sid'].replace('s:', '');
          handshakeData.cookie['connect.sid'] = 
            signature.unsign(sid, SECRET_KEY);
